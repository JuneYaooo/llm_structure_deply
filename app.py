        ...
        with gr.Tab("案例测试"):
            with gr.Column():
                ...
                query = gr.Textbox(label="请输入原文",
                                         lines=1,
                                         interactive=True)
                query_button = gr.Button(value="获得结果")
                query_res = gr.Textbox(type="text", label='')

        with gr.Tab("训练-预测-评估", visible=True):
            gr.Markdown(f"""
            Step1:选择一个Lora
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    train_button = gr.Button("开始训练", value="训练")
                    kill_train_button = gr.Button("停止所有训练进程", value="训练")
                ...
                with gr.Column():
                    ...
                    test_button = gr.Button(value="评估")
                ...
                with gr.Column():
                    ...
                    evaluate_button = gr.Button(value="评估")
...
if __name__ == "__main__":
    tab.queue().launch(server_name='localhost',server_port=8081,share=False, inbrowser=False)  #
