...
class ChatModel:
    ...
    def batch_chat(
        ...
        **input_kwargs,
        ...
        task = asyncio.run_coroutine_threadsafe(self.abatch_chat(batch_messages, system, tools, image, **input_kwargs), self._loop)
        return task.result()
    ...
    async def abatch_chat(
        ...
        **input_kwargs,
        ...
        return await self.engine.batch_chat(batch_messages, system, tools, image, **input_kwargs)
