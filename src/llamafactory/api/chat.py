...
from src.llamafactory.data import Role as DataRole
from src.llamafactory.extras.logging import get_logger
from src.llamafactory.extras.packages import is_fastapi_available, is_pillow_available, is_requests_available
from src.llamafactory.api.common import dictify, jsonify
from src.llamafactory.api.protocol import (
...
if TYPE_CHECKING:
    ...
    from src.llamafactory.api.protocol import ChatCompletionRequest, ScoreEvaluationRequest
